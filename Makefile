...
run: 
	@docker run -p 8088:8088 -p 8089:8089 -p 8188:8188 -p 7889:7889 --name="$(APP_NAME)" -it -t $(NAME)/$(TEMPLATE_NAME)
...
start-mac:
	@docker cp ./configs/janus.jcfg $(APP_NAME):/opt/janus/etc/janus
